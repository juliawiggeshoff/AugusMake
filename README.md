...
If you followed what was recommended in the [System requirements](https://github.com/juliawiggeshoff/AugusMake#local-machine), run this instead:
...
You can use the information from the **total** numbers of jobs to "guide" the value for `--jobs`, while keeping in mind not to "allow" too many jobs at once. So, a value of 25 to 30 jobs might be the safest choice. See [cluster execution](https://github.com/juliawiggeshoff/AugusMake#cluster-execution).
